...
(defn envs
  ...
  {:ci                       (System/getenv "CI")
   ...
   :github_action_path       (System/getenv "GITHUB_ACTION_PATH")
   :github_actions           (System/getenv "GITHUB_ACTIONS")
   :github_action_repository (System/getenv "GITHUB_ACTION_REPOSITORY")
   ...
   :runner_arch              (System/getenv "RUNNER_ARCH")
   })
